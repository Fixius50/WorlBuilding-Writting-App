...
const Breadcrumbs: React.FC<BreadcrumbsProps> = ({ path, currentFolder }) => {
    ...
    return (
        <nav className="flex items-center gap-2 text-[10px] uppercase font-black tracking-widest text-slate-500 mb-6 overflow-x-auto no-scrollbar whitespace-nowrap py-2">
