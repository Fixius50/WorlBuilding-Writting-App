...
const MapEditor: React.FC<MapEditorProps> = ({ mode = 'edit', entityId: propEntityId, onBack, onSave }) => {
    ...
    return (
        <div className="flex flex-col h-screen w-full bg-[#050507] text-white overflow-hidden">
            {/* Header / Toolbar */}
            <header className="h-16 border-b border-white/5 bg-black/40 backdrop-blur-md flex items-center justify-between px-6 z-10">
                <div className="flex items-center gap-4">
                    <button 
                        ...
                        className="size-10 rounded-xl bg-white/5 hover:bg-white/10 flex items-center justify-center transition-all border border-white/5"
                    >
                        <span className="material-symbols-outlined text-sm">arrow_back</span>
                    </button>
                    <div>
                        <h1 className="text-sm font-black uppercase tracking-widest text-white leading-none mb-1">Editor de Atlas</h1>
                ...
                <div className="flex items-center gap-3">
                    <div className="flex items-center bg-white/5 rounded-lg px-3 py-1.5 border border-white/5">
                        ...
                        <span className="text-[10px] text-slate-400 font-medium">Haz clic para añadir un marcador</span>
                    </div>
            ...
            <main className="flex-1 overflow-hidden bg-[radial-gradient(#1a1a2e_1px,transparent_1px)] [background-size:20px_20px] relative">
                ...
                <div className="absolute bottom-6 left-6 p-4 rounded-2xl bg-black/60 backdrop-blur-xl border border-white/10 text-[10px] space-y-2 pointer-events-none shadow-2xl">
                    ...
                    <ul className="text-slate-400 space-y-1">
                        <li>• <span className="text-white">Click</span> en fondo para añadir punto</li>
                        <li>• <span className="text-white">Arrastrar</span> para reposicionar</li>
                        <li>• <span className="text-white">Shift + Click</span> para eliminar</li>
                        <li>• <span className="text-white">Rueda Scroll</span> o arrastrar vacío para navegar</li>
                    </ul>
                </div>
            </main>
        </div>
