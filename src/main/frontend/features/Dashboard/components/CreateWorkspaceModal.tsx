            ...
            <div className="relative w-full max-w-2xl bg-[#0a0a0c] border border-white/10 rounded-3xl shadow-2xl overflow-hidden flex animate-in zoom-in-95 duration-200">
                ...
                <div className="flex-1 p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        {/* ID / Filename */}
                        <div className="space-y-1.5">
                            <label className="text-[10px] font-bold uppercase tracking-widest text-[#94a3b8]">ID de Archivo (Slug)</label>
                            <input
                                type="text"
                                name="name"
                                value={formData.name}
                                ...
                                className="w-full bg-[#13141f] border border-white/10 rounded-xl px-4 py-3 text-white font-mono text-xs focus:border-indigo-500/50 focus:ring-1 focus:ring-indigo-500/50 outline-none transition-all placeholder:text-white/10"
                            />
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                {GENRES.slice(0, 4).map(g => (
                                    <button
                                        ...
                                        className={`px-3 py-2 rounded-lg text-[10px] font-bold border transition-all ${formData.genre === g ? 'bg-indigo-500 text-white border-indigo-500' : 'bg-[#13141f] border-white/10 text-[#94a3b8] hover:border-white/20'}`}
                                    >
                                        {g}
                                    </button>
                                ))}
