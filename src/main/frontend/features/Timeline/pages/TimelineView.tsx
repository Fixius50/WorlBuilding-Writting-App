...
interface TimelineLine extends Carpeta {
    lineasTemporales?: TimelineLine[];
    esRaiz?: boolean;
    descripcion?: string;
}

interface UniverseExtended extends Carpeta {
    lineasTemporales: TimelineLine[];
    descripcion?: string;
}
...
const TimelineView = () => {
    ...
    const startEditUniverse = (uni: any) => {
                ...
                {activeTab === 'eventos' && (
                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
                        <div className="bg-black/20 rounded-xl p-4 border border-white/5">
                                ...
                                {editingEvent && (
                                    <button onClick={() => { setEditingEvent(null); setNewEvent({ titulo: '', descripcion: '', fecha_simulada: '', ordenAbsoluto: events.length + 1 }); }} className="text-[10px] text-slate-500 hover:text-white underline">
