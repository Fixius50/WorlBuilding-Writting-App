...
const GeneralGraphView = () => {
    ...
    if (loading) {
        return (
            <div className="w-full h-full flex flex-col items-center justify-center bg-[#050508] text-slate-500">
                <div className="size-24 rounded-full border border-white/5 flex items-center justify-center mb-6 animate-pulse">
                    <span className="material-symbols-outlined text-5xl">hub</span>
                </div>
                <h3 className="text-xl font-bold text-white/50 mb-2">{t('common.loading')}...</h3>
            </div>
        );
    }
        ...
        <div className="w-full h-full bg-[#050508] relative">
            ...
            >
                ...
                <MiniMap 
                    ...
                    className="bg-surface-dark border border-white/10 rounded-xl"
                />
                ...
                <Panel position="bottom-center" className="p-4 bg-black/40 backdrop-blur-md border border-white/10 rounded-full px-6 py-2 mb-8">
