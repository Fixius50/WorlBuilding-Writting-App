...
@Entity
@Table(name = "entidad_individual")
@org.hibernate.annotations.SQLDelete(sql = "UPDATE entidad_individual SET deleted = true, deleted_date = CURRENT_TIMESTAMP WHERE id = ?")
