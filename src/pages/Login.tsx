...
const Login = () => {
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-[#050508]">
            ...
            <form onSubmit={handleSubmit} className="relative z-10 w-full max-w-md p-8 bg-white/5 backdrop-blur-3xl rounded-[2.5rem] border border-white/10 shadow-2xl">
                <div className="flex flex-col items-center mb-8">
                    <div className="size-16 bg-[#0a0a0c] rounded-2xl flex items-center justify-center mb-4 border border-white/5 shadow-lg shadow-indigo-500/20">
                        <span className="material-symbols-outlined text-4xl text-indigo-400">public</span>
                    </div>
                    <h1 className="text-3xl font-black text-white tracking-tighter">Chronos Atlas</h1>
                    <p className="text-slate-500 mt-2 font-medium">{isRegister ? 'Join the architect\'s guild.' : 'Enter the architect\'s vault.'}</p>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            className="w-full bg-[#0d0d12] border border-white/5 rounded-xl px-4 py-3 text-white focus:border-indigo-500 outline-none transition-all placeholder:text-slate-800"
                    ...
                    <div className="space-y-2">
                        <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Cipher Key</label>
                        <input
                            type="password"
                            name="password"
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full h-14 bg-indigo-500 hover:bg-indigo-400 text-white font-black uppercase tracking-widest rounded-2xl shadow-lg shadow-indigo-500/20 transition-all mt-6 flex items-center justify-center gap-3 disabled:opacity-50"
                    >
                        {loading ? (
                ...
                <div className="mt-8 text-center text-[9px] font-bold text-slate-700 uppercase tracking-[0.3em]">
