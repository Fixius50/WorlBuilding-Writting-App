...
const ActionCard: React.FC<ActionCardProps> = ({ icon, title, desc, color, onClick, t }) => (
 ...
 >
 <div className={`size-14 rounded-none ${color} flex items-center justify-center text-primary-foreground shadow-lg group-hover:scale-110 transition-all duration-500`}>
...
const ProjectView: React.FC = () => {
 ...
 <div>
 <h1 className="text-xl font-black text-foreground tracking-tight uppercase">{projectName}</h1>
 <p className="text-[10px] font-bold text-foreground/50 uppercase tracking-widest">{t('project.dashboard_desc')}</p>
 </div>
 </div>
 </div>
