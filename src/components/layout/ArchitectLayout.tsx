...
const ArchitectLayout: React.FC = () => {
 ...
 monolithic-panel border-l-0
 rounded-r-none flex flex-col items-center justify-center gap-1
 transition-all duration-300 group
 hover:bg-primary/10 hover:border-primary/30
 ${leftOpen ? 'text-primary' : 'text-foreground/50'}
 `}
 >
 ...
 className="absolute bottom-6 left-1/2 -translate-x-1/2 z-40 flex items-center gap-2 px-6 py-2 rounded-full monolithic-panel hover:border-primary/50 hover:bg-foreground/5 transition-all text-foreground/60 hover:text-foreground shadow-2xl group animate-in slide-in-from-bottom-8"
 >
