...
const GlobalRightPanel: React.FC<GlobalRightPanelProps> = ({
 ...
 <aside
 className={`
 fixed top-0 right-0 h-full bg-background border-l border-foreground/10 shadow-2xl z-40 flex flex-col
 ...
 rounded-l-none flex flex-col items-center justify-center gap-1
 transition-all duration-300 group
 hover:bg-indigo-500/10 hover:border-indigo-500/30
 ${isOpen ? 'text-indigo-500 shadow-[-4px_0_15px_-5px_rgba(99,102,241,0.3)]' : 'text-foreground/60'}
 `}
 ...
 {/* Header Tabs */}
 <div className="flex items-center border-b border-foreground/10 bg-white/[0.02]">
 <button
