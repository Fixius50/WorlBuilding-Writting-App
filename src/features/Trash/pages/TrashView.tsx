...
export default function TrashView() {
 ...
 if (loading) return <div className="text-foreground p-8">Loading Trash Bin...</div>;
 ...
 {items.length === 0 ? (
 <div className="flex flex-col items-center justify-center py-20 opacity-50 border border-dashed border-foreground/40 rounded-none">
 <span className="material-symbols-outlined text-4xl mb-2">delete_outline</span>
 <p>Trash is empty</p>
 </div>
 ) : (
 <div className="bg-zinc-900/50 rounded-none border border-foreground/10 overflow-hidden">
 <table className="w-full text-left border-collapse">
 <thead>
 <tr className="border-b border-foreground/10 text-xs text-foreground/40 uppercase tracking-wider">
