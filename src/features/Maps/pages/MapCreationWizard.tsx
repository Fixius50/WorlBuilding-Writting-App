...
const MapCreationWizard = ({ onCancel, onCreate }) => {
 ...
 <select className="w-full monolithic-panel rounded-none px-4 py-3 text-sm text-foreground focus:border-primary/50 outline-none appearance-none">
 <option className="bg-[#1a1a20] text-foreground">Ninguna (Nivel Superior)</option>
 <option className="bg-[#1a1a20] text-foreground">Reino de Aethelgard</option>
 <option className="bg-[#1a1a20] text-foreground">Continente de Aurum</option>
 </select>
...
const InputField = ({ label, placeholder }) => (
 <div className="space-y-1.5">
 <label className="text-[10px] font-black uppercase tracking-widest text-foreground/60 ml-1">{label}</label>
 <input
 type="text"
