                        ...
                        >
                            <div className="flex justify-between items-start mb-2">
                                {editingTitleId === nb.id.toString() ? (
                                    ...
                                    <h4 className="text-xs font-bold text-white truncate pr-6 group-hover:text-primary transition-colors">{nb.titulo}</h4>
                                )}
                            ...
                            <div className="text-[10px] text-slate-500 line-clamp-2" dangerouslySetInnerHTML={{ __html: nb.contenido?.replace(/<[^>]+>/g, '') || 'Sin contenido...' }} />
                        </div>
                    ))
                )}
            </div>
