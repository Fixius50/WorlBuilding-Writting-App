  ...
  return (
    <div className="flex flex-col h-full gap-8 p-6 text-foreground/60">
      <section className="bg-foreground/5 rounded-none p-4 grid grid-cols-4 gap-2">
        {[
          ...
          <button
            ...
            className={`aspect-square rounded-none flex flex-col items-center justify-center gap-1 transition-all ${tool === t.id ? "bg-primary text-foreground shadow-[0_0_15px_hsl(var(--primary)/0.35)]" : "text-foreground/60 hover:text-foreground hover:bg-foreground/10"}`}
            title={t.label}
          >
      ...
      <section className="space-y-6">
        <h3 className="text-xs font-black uppercase tracking-[0.2em] text-primary/60 border-b border-foreground/10 pb-2">
          Propiedades
        </h3>
          ...
          {layers
            ...
            .map((layer) => (
              <div
                ...
                className={`group flex items-center gap-3 p-3 rounded-none border transition-all cursor-pointer ${
              ...
              >
                ...
                <div className="flex-1 flex flex-col">
                  <span
                    className={`text-xs font-bold leading-none ${activeLayerId === layer.id ? "text-foreground" : "text-foreground/60"}`}
                  >
                    {layer.name}
                  </span>
