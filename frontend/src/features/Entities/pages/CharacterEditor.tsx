            ...
            <MonolithicPanel className="p-6 space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <InputField label="Species" value={species} onChange={setSpecies} />
                </div>
              </div>
            </MonolithicPanel>
          </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                ...
                <button onClick={handleAddAttribute} className="text-primary text-xs font-bold hover:underline">+ Add Attribute</button>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {attributes.map((stat, idx) => (
                  <EditorStat key={idx} label={stat.label} value={stat.value} />
                ))}
              </div>
            </div>
          </div>
