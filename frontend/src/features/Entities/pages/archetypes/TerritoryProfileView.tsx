...
const TerritoryProfileView: React.FC<{ entityId?: string | number }> = ({ entityId: propEntityId }) => {
  ...
  const tabs = [
    ...
    { id: 'CARTOGRAFÍA_TÁCTICA', label: 'CARTOGRAFÍA_TÁCTICA', icon: 'map' },
  ...
  return (
    <div className="flex-1 bg-black flex flex-col rounded-none overflow-hidden h-full w-full">
      ...
      <div className={`flex-1 relative ${activeTab === 'CARTOGRAFÍA_TÁCTICA' ? 'overflow-hidden' : 'overflow-y-auto custom-scrollbar'}`}>
        {activeTab === 'REGISTRO' && (
        ...
        {activeTab === 'CARTOGRAFÍA_TÁCTICA' && (
          <div className="w-full h-full relative bg-black flex items-center justify-center">
             <div className="text-primary/40 font-mono tracking-widest uppercase text-xs animate-pulse text-center">
                 [ INICIANDO CONEXIÓN SATELITAL... CARGANDO LEAFLET_MAP_VIEW ]
             </div>
          </div>
        )}
