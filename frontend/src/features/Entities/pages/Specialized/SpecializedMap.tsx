...
const SpecializedMap = ({ entity, active }) => {
 ...
 <span className="text-[10px] uppercase font-black tracking-widest text-emerald-100 bg-background/50 px-2 py-1 rounded-full border border-emerald-500/30 opacity-0 group-hover/pin:opacity-100 transition-opacity">Capital City</span>
 </div>
 ...
 <span className="text-[10px] uppercase font-black tracking-widest text-indigo-100 bg-background/50 px-2 py-1 rounded-full border border-indigo-500/30 opacity-0 group-hover/pin:opacity-100 transition-opacity">Old Fortress</span>
 </div>

 {/* UI Overlay */}
 <div className="absolute top-4 left-4 flex gap-2">
 <button className="p-2 rounded-none sunken-panel/80 border border-foreground/10 hover:bg-foreground/10 text-foreground transition-all shadow-xl">
