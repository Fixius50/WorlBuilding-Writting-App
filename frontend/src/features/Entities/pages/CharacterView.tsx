...
import { useCharacterView, CharacterRelationship, CharacterData } from './useCharacterView';
      ...
      <div className="flex-1 flex flex-col overflow-y-auto custom-scrollbar p-8 gap-6">
        ...
        <div className="flex items-start gap-6">
          ...
          <div className="flex gap-2">
            {!isEditing && (
              <button 
                className="px-4 py-2 text-[10px] font-black uppercase tracking-widest border border-red-500/30 text-red-400 hover:bg-red-500/10 transition-all flex items-center gap-2"
