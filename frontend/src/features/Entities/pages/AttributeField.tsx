...
const AttributeField: React.FC<AttributeFieldProps> = ({ 
 ...
 return (
 <div className="monolithic-panel rounded-none p-2 space-y-1 max-h-40 overflow-y-auto custom-scrollbar">
 ...
 {value && (
 <div className="w-full aspect-video rounded-none monolithic-panel overflow-hidden relative group">
 ...
 default:
 return (
 <div className="text-sm font-medium text-foreground/70 italic p-2 rounded-none monolithic-panel">
