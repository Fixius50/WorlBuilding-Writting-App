...
export const useMapEditor = (
  ...
  const [targetFolderId, setTargetFolderId] = useState<number | null>(folderId ? Number(folderId) : null);
  ...
  return {
    ...
    lineContinuous, setLineContinuous,
    ...
    processingLayers, errorLayers,
    mapRef, fileInputRef,
    openPanel, setCustomContent, closePanel
  };
};
