                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 h-full">
                  ...
                  <div className="flex flex-col space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="p-4 bg-foreground/[0.02] border border-foreground/5 flex flex-col space-y-1">
                        <span className="text-[8px] font-black uppercase text-foreground/40 tracking-widest">PÃƒÂ¡ginas Totales</span>
                    ...
                    <div className="p-4 bg-primary/5 border border-primary/20 flex items-center gap-3">
                      ...
                      <span className="text-[9px] font-black uppercase tracking-widest text-primary">SesiÃƒÂ³n de Escritura Activa</span>
                    </div>
                  </div>
                    ...
                    <div className="flex-1 bg-foreground/[0.01] border border-foreground/5 p-4 min-h-[300px]">
                      {statsData?.pages ? (
                        ...
                        <div className="w-full h-full flex flex-col items-center justify-center text-foreground/20 space-y-2">
                          ...
                          <span className="text-[10px] font-black uppercase tracking-widest italic">Abre un cuaderno para ver analÃƒÂ­ticas</span>
                        </div>
                      )}
                    </div>
                  </div>
