            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center gap-6 p-6 bg-foreground/5 rounded-none border border-foreground/10 group relative overflow-hidden">
                  ...
                  <div className="flex-1 space-y-2">
                    <input
                      ...
                      placeholder={
                        user?.username || "Tu nombre de arquitecto..."
                      }
              ...
              <section className="monolithic-panel rounded-none p-8 space-y-6">
                ...
                <div className="flex items-center justify-between p-4 bg-foreground/[0.02] border border-foreground/10 rounded-none mb-6">
                  <div>
                    ...
                    <p className="text-[10px] text-foreground/50 mt-1">
                      Guarda una copia en el servidor local cada 10 minutos (si
                ...
                <div className="space-y-4">
                  <label className="text-[10px] font-black uppercase tracking-widest text-foreground/60 block">
                    Universos para sincronización
                  </label>
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-6">
                  {themes.map((theme) => {
                    ...
                    return (
                      <div
                        key={theme.id}
                        className={`relative flex flex-col gap-3 p-4 rounded-none border transition-all ${isSelected ? "border-primary bg-primary/5 ring-1 ring-primary/30" : "sunken-panel hover:border-foreground/40"}`}
                      >
                        <div
                          className="h-24 rounded-none flex items-center justify-center overflow-hidden border border-foreground/10"
                        ...
                        <div className="flex flex-col gap-1 items-center mt-2">
                          ...
                          <span className="text-[9px] font-bold text-foreground/40 uppercase tracking-widest">
                            {isSelected ? "ESTILO ACTIVO" : "DISPONIBLE"}
                          </span>
                        </div>
                        ...
                        <div className="flex items-center mt-3 border border-foreground/20 rounded-none overflow-hidden">
                          ...
                          <button
                            onClick={() =>
                              updateSetting("theme", `${theme.id}_light`)
                            }
                            className={`flex-1 py-1.5 flex items-center justify-center gap-1 text-[9px] font-black uppercase tracking-widest transition-all
                        ...
                        {mode === "binder" && (
                          <div className="w-full h-full flex gap-1">
                            <div className="w-1/3 h-full bg-foreground/20 flex flex-col gap-1">
                              <div className="h-2 w-full flex gap-1">
                                <div className="flex-1 bg-foreground/40"></div>
                                <div className="flex-1 bg-foreground/20"></div>
                              </div>
              ...
              <section className="monolithic-panel rounded-none p-8">
                ...
                <div className="grid grid-cols-2 gap-12">
                  <div className="space-y-4">
                    ...
                    <div className="relative">
                      ...
                      >
                        <option value="Lexend" className="text-foreground">
                          Lexend (UI Moderna)
                        </option>
                        <option value="Outfit" className="text-foreground">
                          Outfit (Sleek)
                        </option>
                        <option
                        ...
                        <option
                          ...
                          className="text-foreground"
                        >
                          JetBrains Mono (Codex)
                        </option>
                      </select>
                      <span className="material-symbols-outlined absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none text-foreground/60">
                        expand_more
                      </span>
                    </div>
                  </div>
                ...
                <div className="mt-8 p-6 bg-background/40 rounded-none border border-foreground/10 text-center shadow-inner">
                  ...
                  >
                    "El universo es un libro escrito en el lenguaje de las
                    historias."
                  </p>
                </div>
              </section>
