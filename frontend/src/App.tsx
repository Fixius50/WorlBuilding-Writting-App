...
import { TimelineView, TimelineEditor } from "@features/Timeline";
          ...
          <Routes>
            ...
            <Route element={<AppLayout />}>
              ...
              <Route path="/local/:projectName" element={<ArchitectLayout />}>
                ...
                <Route
                  path="entities/:type/:entityId"
                  element={<EntityRouter />}
                />

                <Route
                  path="map-editor/create/:folderId"
                  element={<MapEditor />}
                />
                <Route
                  path="map-editor/edit/:entityId"
                  element={<MapEditor />}
                />
                ...
                <Route path="bible" element={<WorldBibleLayout />}>
                  ...
                  <Route
                    path="folder/:folderId/entity/new/:type"
                    element={<EntityBuilder mode="creation" />}
                  />
                  <Route path="folder/:folderId" element={<BibleGridView />} />
                  <Route
                    path="timeline/:folderId"
                    element={<TimelineEditor />}
                  />
                  <Route path="entity/:entityId" element={<EntityRouter />} />
                  <Route
                    path="entity/:entityId/edit"
                    element={<EntityEditRouter />}
                  />
                  <Route
                    path="folder/:folderId/entity/:entityId"
                    element={<EntityRouter />}
                  />
                  <Route
                    path="folder/:folderId/entity/:entityId/edit"
                    element={<EntityEditRouter />}
                  />
                </Route>
                ...
                <Route
                  path="planning/:pizarraId"
                  element={<PlanningCenterView />}
                />
