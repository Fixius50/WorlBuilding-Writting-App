...
>
> [!IMPORTANT]
> **POLÍTICA DE LOGS MINIMALISTAS (ACTIVA)**: Los errores ahora se reportan con formato ultra-simplificado: `NUM_ERROR RUTA/ACCIÓN`.
> Se ha eliminado la verbosidad de stack traces en el reporte de usuario para mantener la terminal limpia.
**Timestamp:** 2026-01-25T01:29:06.462043900
**Request:** GET /favicon.ico
**Exception:** org.springframework.web.servlet.resource.NoResourceFoundException
**Message:** No static resource favicon.ico.
